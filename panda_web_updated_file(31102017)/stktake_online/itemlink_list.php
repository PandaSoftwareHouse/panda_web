    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                <h4><b><?php echo $_SESSION['description']?></b>
                                    ...
                                    <?php
                                        foreach ($itemlink->result() as $row)
                                        {
                                            ...
                                            <tr>
                                              ...
                                              <td class="big" ><a href="<?php echo site_url('stktake_online_controller/item_edit')?>?trans_guid=<?php echo $row->TRANS_GUID?>"><?php echo $row->DESCRIPTION; ?></a></td>
