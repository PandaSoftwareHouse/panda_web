    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('stktake_controller/scan_binID'); ?>">
                        ...
                        <?php // echo var_dump ($_SESSION) ?>
                            ...
                            <input type="text" class="form-control" placeholder="Scan User_ID" name="user_ID" id="textarea" required autofocus onblur="this.focus()"/>

                            <!-- <input value="<?php echo $location?>" name="location" type="hidden"> -->
