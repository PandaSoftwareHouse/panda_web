        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url('Stktake_controller/edit_qty'); ?>">
                        <div class="form-group">
                          ...
                          foreach($item->result() as $row)
                          {
                            ...
                            <h5><b>Barcode edit: </b><?php echo $row->barcode;?> &nbsp
                            <b>P/Size: </b><?php echo $row->packsize;?></h5>
                            <h5><b>Desc: </b><?php echo $row->description?></h5>
                          ...
                          <div class="col-md-12">
                           ...
                           <?php // echo var_dump($_SESSION)?> 
                                ...
                                <div style="float:left">
                                    ...
                                    min="0" max="100000" disabled step='any'
                                    <?php  
                                ...
                                <div style="float:left;margin-left:12px">
                                   ...
                                   <?php if($_SESSION['get_weight'] == '' ) {?>
                                    ...
                                    <input autofocus onclick="this.focus();this.select()" required type="decimal" value="<?php echo $_SESSION['get_weight'] ?>" name="iqty" style="text-align:center;width:80px;" step='any'/>
                                     <!-- <input hidden type="decimal" name="iqty" style="text-align:center;width:80px;" /> 
