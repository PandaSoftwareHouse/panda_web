        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a onclick="history.go(-1)" href="<?php echo site_url('general_scan_controller/scan_item?web_guid='.$_SESSION['web_guid'].'&acc_code='.$_SESSION['acc_code']) ?>" style="float:right">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url("general_scan_controller/update_qty?web_guid=".$_SESSION['web_guid']); ?>">
                          ...
                          <div class="col-md-12">
                                ...
                                <div style="float:left;margin-left:12px">
                                    ...
                                    if(isset($_SESSION['decode_qty']))
                                        {
                                          ?>
                                          <input autofocus required type="number" value="<?php echo $_SESSION['decode_qty']?>" onfocus="this.select()" step="any" max="100000" name="iqty" style="text-align:center;width:80px;" />
                                          <?php
                                        }
                                        else
                                        {
                                    ...
                                    ?>
                                   <!--  <input autofocus required type="number" value="0" onfocus="this.select()" step="any" name="iqty" style="text-align:center;width:80px;" max="100000"/> -->
                                    <h5><b>Remarks</b></h5>
