                ...
                <div class="col-md-4">
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('greceive_controller/item_entry_update')?>?>">
                        <div class="form-group">
                            ...
                            {
                                ?>
                                PO BAL:<b style="float:right"><?php echo $query_heading->row('po_bal')?></b>
                                <?php
                            } 
                            ?>
                          </h4>  
                                    ...
                                    foreach($query_item->result() as $row)
                                    {
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="big"><a href="<?php echo site_url('greceive_controller/item_entry_add')?>?scan_itemcode=<?php echo $row->itemcode?>"><?php echo convert_to_chinese($row->description, "UTF-8", "GB-18030");?></a></td>
                                            </tr>
                                        </tbody>
                                        <?php
                                    }
