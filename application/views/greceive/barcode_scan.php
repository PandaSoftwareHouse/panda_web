        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url('greceive_controller/barcode_scan_result'); ?>">
                    ...
                    if($by_batch == 1)
                    {
                      ...
                      {
                        ?>
                        <a href="<?php echo site_url('greceive_controller/barcode_scan')?>?by_batch"><button type="button" class="btn btn-primary">Scan By Batch</button></a>
                        <?php
                      }
                      else
                      {
                        ?>
                        <a href="<?php echo site_url('greceive_controller/barcode_scan')?>?by_qty"><button type="button" class="btn btn-success">Scan By Qty</button></a>
                        <?php
                      }
                      ?>
                      </div>
