                    ...
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('greceive_controller/item_entry_update')?>?item_guid=<?php echo $_REQUEST['item_guid']?>&batch_guid=<?php echo $_REQUEST['batch_guid']?>&posum_guid=<?php echo $_REQUEST['posum_guid']?>">
                        <div class="form-group">
                           ...
                           FOC: <b><?php echo $foc_qty?></h5>
                                ...
                                <h4>Description: <b><?php echo convert_to_chinese($description, "UTF-8", "GB-18030"); ?>&nbsp&nbsp&nbsp&nbsp<?php echo $line_no?></b></h4>
                                <h4>Barcode: <b><?php echo $_SESSION['barcode'];?></b></h4>
                                ...
                                <?php if($check_pay_by_invoice == '1') { ?>
                                  <div class="col-md-5 col-xs-3 form-group">
                                    <h5 ><b>D/O Qty</b></h5>
                                    <input autofocus
                                     value="<?php echo $do_qty?>" style="text-align:center;width:80px;background-color:#ffff99" name="do_qty" type="number" step="any" onfocus="this.select()"/>
                                     <input type="hidden" name="balance_qty" value="<?php echo $balance_qty?>">
                                  </div>
                                  <?php } else { ?> 
                                    <input value="<?php echo $do_qty?>" name="do_qty" type="hidden">
                                     <input type="hidden" name="balance_qty" value="<?php echo $balance_qty?>">

                                  <?php } ?>
                                  <div class="col-md-6 col-xs-6 form-group">
                                    <h5><b>Rec Qty/Kg</b></h5>
                                    <input value="<?php echo $received_qty?>" name="rec_qty" type="number" step="any" style="text-align:center;width:80px;background-color:#80ff80"  />
                                  </div>
                                </div>
