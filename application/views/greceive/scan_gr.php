        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url('greceive_controller/search_gr_result'); ?>">
                        <div class="form-group">
                            <span class="input-group-btn">
                            <input type="text" class="form-control" placeholder="Scan GR No" name="gr_no" id="textarea" required autofocus onblur="this.focus()"/>
                            </span>
                        </div>
                    </form>
                    <br>
