...
<head>
    ...
    <!-- ANGULAR -->
    <script src="<?php echo base_url('assets/jquery/angular.min.js');?>"></script>

    <script type="text/javascript" src="jquery-1.11.3-jquery.min.js"></script>
    <script src="<?php echo base_url('assets/jquery/jquery-latest.min.js');?>" type="text/javascript"></script>
    <script src="<?php echo base_url('assets/jquery/jquery-1.10.2.js');?>"></script>
    
    <!--TABLE STYLES-->
    <script type="text/javascript" src="<?php echo base_url('assets/table/jquery-latest.js');?>"></script>
    <script type="text/javascript" src="<?php echo base_url('assets/table/jquery.tablesorter.js');?>"></script>
