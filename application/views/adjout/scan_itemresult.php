                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url('general_scan_controller/add_qty'); ?>">
                        <div class="form-group">
                          ...
                          {
                            ?>
                            <h5><b>Barcode add new: </b><?php echo $row->barcode;?> &nbsp
                          ...
                          <div class="col-md-12">
                           ...
                           <?php   echo var_dump($_SESSION)?> 
                                ...
                                <div style="float:left;margin-left:12px">
                                    <h5><b>Input Qty</b></h5>
                                     <?php if($_SESSION['get_weight'] == '' ) {?>
                                    <input autofocus required type="decimal" name="iqty" style="text-align:center;width:80px;" />
                                    <?php }else {?>
                                    <input disabled type="decimal" value="<?php echo $_SESSION['get_weight'] ?>" name="iqty" style="text-align:center;width:80px;" />
                                     <input hidden type="decimal" value="<?php echo $_SESSION['get_weight'] ?>" name="iqty" style="text-align:center;width:80px;" />
                                    <?php }?>
                                    <h5><b>Remarks</b></h5>
