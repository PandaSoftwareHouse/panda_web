        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a onclick="history.go(-1)" href="<?php echo site_url('adjout_controller/scan_item')?>" style="float:right">
                        <i class="fa fa-arrow-left" style="color:#4380B8;margin-right:20px"></i></a>

                        <font>Adjust Out Weight
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url('adjout_controller/add_qty'); ?>">
                        ...
                        <?php  echo $_price; ?>
                          ...
                          {
                            ?>
                            <h5><b>Barcode weightt: </b><?php echo $row->barcode;?> &nbsp
                            ...
                            <h5><b>Selling Price: </b><?php echo $sellingprice?> &nbsp
                            ...
                            <input value="<?php echo $sellingprice?>" name="sellingprice" type="hidden">
                            <?php
                          }
                          ...
                          <div class="col-md-12">
                           ...
                           <?php  // echo var_dump($_SESSION)?> 
                                ...
                                <div style="float:left;margin-left:12px">
                                    <h5><b>Qty1</b></h5>
                                    <input autofocus disabled type="decimal" name="iqty"  value="<?php // echo $weight_p?>" style="text-align:center;width:80px;" max="100000"/>
                                    <h5><b>Remarks</b></h5>
