                ...
                <div class="row">
                    <div class="col-md-12">
                      ...
                      <h1 class="page-head-line">
                        ...
                        <a id="dontprint" href="<?php echo site_url('pandarequest_controller/backhome')?>" style="float:right">
                        <i id="dontprint" class="fa fa-home" style="color:#4380B8;margin-right:20px"></i></a>

                        <a id="dontprint" href="<?php echo site_url('pandarequest_controller/stock_view_transaction')?>" style="float:right"><i class="fa fa-arrow-left" style="color:#4380B8;margin-right:20px""></i></a>
