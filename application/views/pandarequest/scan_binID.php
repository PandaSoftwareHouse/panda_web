            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        <!--<a href="<?php echo site_url('logout_c/logout')?>" style="float:right"><i class="fa fa-sign-out" style="font-size:32px;color:#4380B8"></i></a>-->
                ...
                <div class="col-md-4">
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('pandarequest_controller/scan_binID'); ?>">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Scan Bin_ID" 
                            name="bin_ID" required onblur="this.focus()" autofocus="autofocus" id="autofocus"/>
                            </span>
                        </div>
                    </form><br>
                </div>
