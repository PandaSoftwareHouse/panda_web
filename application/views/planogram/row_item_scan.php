...
function check()
{
    var answer=confirm("DELETE ALL LISTED ITEM?");
    return answer;
}
</script>
<!--onload Init-->
    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                <h5><b>Bin ID:</b> <?php echo $bin_ID?><b>&nbsp&nbsp&nbsp&nbsp<?php echo $row_no?></b>
                
                <a style="float:right;" href="<?php echo site_url('planogram_controller/rack_row_item_delete_all')?>?row_guid=<?php echo $_REQUEST['row_guid']?>&bin_ID=<?php echo $bin_ID?>" class="btn btn-xs btn-danger" onclick="return check()"><span class="glyphicon glyphicon-trash"></span> 
                </a>
                </h5>
                <br>
                    <form class="form-inline" role="form" method="POST" id="myForm" 
                    action="<?php echo site_url('planogram_controller/row_item_scan_result'); ?>">
