            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a onclick="history.go(-1)" href="<?php echo site_url('general_scan_controller/scan_item')?>?web_guid=<?php echo $_SESSION['web_guid']?>&acc_code=<?php echo $_REQUEST['acc_code']?>" style="float:right">
                    ...
                    action="<?php echo site_url('general_scan_controller/add_qty'); ?>">
                        <div class="form-group">
                          ...
                          foreach($itemresult->result() as $row)
                          {
                           ...
                           <!--  <input value="<?php echo $row->web_c_guid?>" name="web_c_guid" type="hidden"> -->
                            <?php
                          }
                        ...
                        <div class="row">
                          <div class="col-md-12">
                                ...
                                <div style="float:left">
                                    ...
                                    <b style="font-size:28px">&nbsp&nbsp&nbsp +</b>
                                ...
                                <div style="float:left;margin-left:12px">
                                    ...
                                    {
                                    ?>
                                    <input disabled type="number" step="any" value="<?php echo $_SESSION['get_weight'] ?>" name="iqty" style="text-align:center;width:80px;" />
                                     <input hidden type="number" step="any" value="<?php echo $_SESSION['get_weight'] ?>" name="iqty" style="text-align:center;width:80px;" />
                                    <?php }?>
