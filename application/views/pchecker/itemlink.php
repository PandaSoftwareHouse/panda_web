            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <font>price checker<br><small><b>itemlink</b></small>
                          ...
                          <div class="col-md-12">
                                <div style="overflow-x:auto;">
                                  ...
                                  <thead style="cursor:s-resize">
                                    <tr>
                                      <th style="text-align:center;">Item Link</th>
                                  ...
                                  <tbody>
                                    <?php
                                        foreach ($result->result() as $row)
                                        {
                                            ?>
                                            <tr>
                                              <td style="text-align:center;font-size: 12px"><?php echo $row->Itemlink; ?></td>
