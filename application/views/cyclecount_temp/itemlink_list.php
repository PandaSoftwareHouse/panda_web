    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                <h4><b><?php echo mb_convert_encoding($_SESSION['description'], "UTF-8", "GB-18030");?></b>
                                    ...
                                    <?php
                                        foreach ($itemlink->result() as $row)
                                        {
                                            ...
                                            <tr>
                                              ...
                                              <td class="big" ><a href="<?php echo site_url('cyclecount_bytemplate_controller/item_edit')?>?trans_guid=<?php echo $row->TRANS_GUID?>"><?php echo mb_convert_encoding($row->DESCRIPTION, "UTF-8", "GB-18030"); ?></a></td>
