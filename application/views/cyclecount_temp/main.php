                            ...
                            <h4><b>LOCATION:</b><?php echo $_SESSION['location'];?></h4>
                                <div style="float:left">
                                    <p><b>DATE:</b></p>
                                        ...
                                        <a style="color: white" href="<?php echo site_url('cyclecount_bytemplate_controller/scan_item'); ?>"><button value="go" name="go" type="submit" class="btn btn-info btn-xs" ><b>NEXT</b>
                                        </button></a>
                                </div>
                        </div>
                    <br>
