            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a href="<?php echo site_url('cyclecount_bytemplate_controller/main')?>" style="float:right" >
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <h5>Stock Take @ <?php echo $_SESSION['stktake_date'];?></h5>
                    ...
                    action="<?php echo site_url('cyclecount_bytemplate_controller/scan_item_result'); ?>">
