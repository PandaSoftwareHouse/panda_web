    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a href="<?php echo site_url('cyclecount_bytemplate_controller/itemlink_list')?>" style="float:right">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                <h4><b><?php echo mb_convert_encoding($Desc, "UTF-8", "GB-18030");?></b>
                <small>P/size : <?php echo $Size?></small></h4>
                <h5><b>QOH : </b><?php echo $OnHand?> &nbsp&nbsp</h5>
                
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('cyclecount_bytemplate_controller/item_edit_save')?>">
