            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a href="<?php echo site_url('adjin_controller/main')?>" style="float:right">
                        ...
                        <font>Adjust In
                          ...
                          <br>
                          <a href="<?php echo site_url('general_scan_controller/general_post')?>?type=Adjust-In&header_guid=<?php echo $_REQUEST['web_guid'] ?>&location=<?php echo $_SESSION['location'] ?>&redirect_controller=adjin_controller&redirect_function=main" ><button class="btn btn-default btn-sm" style=""><b><i class="fa fa-print fa-lg"></i> Send Print</b></button></a> 
                          <?php } ?>
                        </font>
