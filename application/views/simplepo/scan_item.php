    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a href="<?php echo site_url('Simplepo_controller/main') ?>" style="float:right">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('Simplepo_controller/scan_itemresult'); ?>">
