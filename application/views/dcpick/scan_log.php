            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <font>scan log<br><small><b><?php echo $type?></b></small>
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                          ...
                          <h5><b>Request No :</b> <?php echo $_SESSION['dc_refno']?></h5>
                                        ...
                                        foreach ($result->result() as $row)
                                        {
                                            ...
                                            <tr>
                                              ...
                                              <td class="big" style="text-align:center;"><?php echo $row->created_at; ?>
                                                <a style="float:right;" href="<?php echo site_url('Dcpick_controller/scan_log')?>?delete_scan&item_guid=<?php echo $row->item_guid?>&scan_guid=<?php echo $row->scan_guid?>&type=<?php echo $type ?>" class="btn btn-xs btn-danger" onclick="return check()">
