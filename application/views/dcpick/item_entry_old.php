                          ...
                          <table class="table table-striped table-bordered table-hover" style="width:100">
                                ...
                                <tbody>
                                    <tr>
                                      ...
                                      { ?>
                                        <td style="text-align:left;"><b style="color:red ;font-weight:bold; font-size: 25px">*</b> &nbsp <?php echo $row->description; ?></td>
                                      <?php } 
                                      else { ?>
                                ...
                                <input value="<?php echo echo htmlentities(convert_to_chinese($row->description, "UTF-8", "GB-18030")); ?>" name="description[]" type="hidden">
