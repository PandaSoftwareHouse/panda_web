        ...
        <div class="fixed">
            ...
            <div class="row" >
                ...
                <div class="col-md-8">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <a href="<?php echo site_url('simpleso_controller/add_remarks')?>">
                                  ...
                                  <tbody>
                                    <?php
                                        foreach ($result->result() as $row)
                                        {
                                            ...
                                            ?>
                                            <tr>
                                              <td><a href="<?php echo site_url('simpleso_controller/itemlist')?>?web_guid=<?php echo $row->web_guid?>&remarks=<?php echo $row->remarks ?>&bill_amt=<?php echo $row->bill_amt?>"><?php echo $row->remarks; ?></a></td>
