...
<br>
<?php
                        $parent_name = $this->db->query("SELECT parent_name FROM backend_warehouse.`module_menuci` GROUP BY parent_name ORDER BY parent_sequence ASC;");
                        ...
                        <li class="menu">
                            ...
                            $i = 0;
                                ...
                                FROM backend_warehouse.`module_menuci` AS a
