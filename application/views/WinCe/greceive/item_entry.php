...
<form role="form" method="POST" id="myForm" action="<?php echo site_url('greceive_controller/item_entry_update')?>?item_guid=<?php echo $_REQUEST['item_guid']?>">
    ...
    <tr>
      <td colspan="3">Barcode: <b><?php echo $_SESSION['barcode']; ?></b></td>
    </tr>
    <tr>
  ...
  <table width="200" border="0">
    ...
    <tr>
      <td><input autofocus onfocus="this.select()" value="<?php echo $do_qty?>" class="form-control" style="text-align:center;width:80px;background-color:#ffff99" name="do_qty" type="number"/>
        <input type="hidden" name="balance_qty" value="<?php echo $balance_qty?>">
      </td>
      <td><input value="<?php echo $received_qty?>" class="form-control" name="rec_qty" type="number" style="text-align:center;width:80px;background-color:#80ff80" id="autofocus"/>
     </td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="<?php echo $hide_weight?>"><input autofocus value="<?php echo $scan_weight?>" type="number" class="form-control" name="weight" style="text-align:center;width:80px;background-color:#e6ccff" onfocus="this.select()"/>
</td>
<td>
  <?php
    if($check_trace_qty == '1')
