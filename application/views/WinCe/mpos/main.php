...
<p><a href="<?php echo site_url('mpos_controller/add_remarks')?>" class="btn_primary">+ ADD TRANS</a></p>
...
<thead>
  ...
  <tr>
    <td class="cTD">
    <a href="<?php echo site_url('mpos_controller/itemlist')?>?web_guid=<?php echo $row->web_guid?>&remarks=<?php echo $row->remarks ?>&bill_amt=<?php echo $row->bill_amt?>"><?php echo $row->remarks; ?></a>
    </td>
