...
<label>Scan Transaction Ref</label><br>                        
<input type="text" class="form-control" placeholder="Scan Transaction Ref" style="background-color: #e6fff2" name="refno" id="autofocus" />
<br>
