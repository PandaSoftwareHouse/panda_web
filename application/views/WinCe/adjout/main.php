...
<p><a href="<?php echo site_url('adjout_controller/add_remarks')?>" class="btn_primary"> + ADD TRANS</a></p>
<table width="200" class="cTable">
  <thead> 
  <tr>
    <td class="cTD">Reason</td>
    <td class="cTD" style="text-align:center;">Amount</td>
    <td class="cTD" style="text-align:center;">Remarks</td>
  ...
  <tr>
    <td class="cTD">
    <a href="<?php echo site_url('adjout_controller/itemlist')?>?web_guid=<?php echo $row->web_guid?>&remarks=<?php echo $row->remarks ?>&bill_amt=<?php echo $row->bill_amt?>"><?php echo $row->reason; ?></a></a>
    </td>
    <td class="cTD" style="text-align:center;"><?php echo round($row->bill_amt,2) ?></td>
    <td class="cTD" style="text-align:center;"><?php echo $row->remarks; ?></td>
