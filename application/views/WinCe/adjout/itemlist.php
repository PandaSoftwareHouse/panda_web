...
<table width="200"  class="cTable">
  ...
  <tr>
    ...
    <!-- delete button -->
    <a style="float: right" href="<?php echo site_url('Adjout_controller/delete_item'); ?>?web_c_guid=<?php echo $row->web_c_guid ;?>&web_guid=<?php echo $row->web_guid ;?>" onclick="return confirm('Are you sure you want to delete this item?')" onSubmit="window.location.reload()"><img src="<?php echo base_url('assets/icons/garbage.jpg');?>"></a>
  </td>
