...
<form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('formpallet_controller/item_entry_insert')?>?item_guid=">

<h4><?php echo $_SESSION['barcode']?>&nbsp&nbsp&nbsp&nbsp<b><?php echo $line_no->row('reccount')?>&nbsp&nbsp <?php echo $WeightTraceQtyUOM?></b></h4>
                              
<h4><b><?php echo $description?></b></h4>
<h5><b>Weight(kg)</b></h5>
<input autofocus onfocus="this.select()" id="autofocus" value="<?php echo $scan_weight?>" class="form-control" type="number" step="any" style="text-align:center;width:80px;background-color:#ffff99" name="weight" />
<br>
