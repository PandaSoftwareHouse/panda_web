...
<body>
    <div id="wrapper">
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                      <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('main_controller/sendprint'); ?>">
                      <h1 class="page-head-line">
                        ...
                        <a id="dontprint" href="<?php echo site_url('main_controller/view_transaction')?>" >
                        <i class="fa fa-arrow-left" style="font-size:32px;color:#4380B8;margin-right:20px"></i></a>

                        <!--<a id="dontprint" href="<?php echo site_url('main_controller/scanbarcodeview')?>">
                        ...
                        <a id="dontprint" href="<?php echo site_url('main_controller/home')?>" style="float:right">
