            ...
            <div id="page-inner">                
                ...
                <ul class="nav" id="main-menu">
                  ...
                  <!--           <a href="<?php echo site_url('logout_c/clearSession')?>"  title="clearSession" >
                            ...
                            <a href="<?php echo site_url('main_controller/reload_from_dropbox')?>"  title="Reload" onclick="move()"><i class="fa fa-dropbox" style="color:black;font-size:20px;margin-right:10px""></i></a>
                            <?php } ?>
