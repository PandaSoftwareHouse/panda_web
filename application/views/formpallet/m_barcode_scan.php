        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a href="<?php echo site_url('formpallet_controller/m_batch_entry')?>?batch_guid=<?php echo $_SESSION['batch_guid']?>" style="float:right">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url('formpallet_controller/m_barcode_scan_result'); ?>">
