    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('dnbatch_controller/scan_supresult'); ?>">
                        <div class="form-group">
                            <span class="input-group-btn">
                            <h4>Scan an item to create a supplier batch</h4> 
