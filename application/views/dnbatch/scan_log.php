                                        ...
                                        foreach ($result->result() as $row)
                                        {
                                            ...
                                            <tr>
                                              ...
                                              <td class="big" style="text-align:center;"><?php echo $row->created_at; ?>
                                               ...
                                               <a style="float:right;" href="<?php echo site_url('Dnbatch_controller/delete_scan_log')?>?scan_guid=<?php echo $row->scan_guid;?>&batch_no=<?php echo $row->refno;?>&item_guid=<?php echo $row->item_guid;?>" class="btn btn-xs btn-danger" onclick="return check()">
