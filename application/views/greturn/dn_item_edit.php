    ...
    <div id="wrapper">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <a href="<?php echo site_url('greturn_controller/dn_item_list?sup_code='.$_REQUEST['sup_code'])?>" style="float:right">
            ...
            <div class="row">
                    <!--1.1-->
                <div class="col-md-4">
                    <form class="form-inline" role="form" method="POST" id="myForm" action="<?php echo site_url('greturn_controller/dn_item_edit_update')?>">
                        <div class="form-group">
                                <h4><b><?php echo convert_to_chinese($description, "UTF-8", "GB-18030");?></b></h4>
                                <div style="float:left">
                                    <h5 >Qty</h5>
                                    <input type="number" step="any" value="<?php echo $qty?>" style="text-align:center;width:80px;background-color:#ffff99" max="9999" name="qty" autofocus onfocus="this.select()"
                                    <?php
                                    if($edit_mode == 'delete')
                                    {
                                      ?>
                                ...
                                {
                                    ?>
                                <option <?php if($last_supplier == $row->supplier)
                                        {
                                          echo 'selected';
                                        }; 
                                        ?>>
                                          <?php echo $row->supplier;?></option>
                                    <?php
                                }
                                ?>
                                </select>
                               ...
                               <!--  <option selected="select" default><?php echo $last_reason?></option> -->
                                ...
                                {
                                    ?>
                                <option  <?php if($last_reason == $row->code_desc)
                                        {
                                          echo 'selected';
                                        }; 
                                        ?>>
                                          <?php echo $row->code_desc;?></option>
                                    <?php
                                }
                                ?>
                                </select>
