        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    action="<?php echo site_url('ibt_rec_controller/scan_ibt_result'); ?>">
                        <div class="form-group">
                            <span class="input-group-btn">
                            <input type="text" class="form-control" placeholder="Scan IBT No" name="ibt_no" id="textarea" required autofocus onblur="this.focus()"/>
                            </span>
                        </div>
                    </form>
                    <br>
