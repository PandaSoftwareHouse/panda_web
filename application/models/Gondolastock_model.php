...
class gondolastock_model extends CI_Model
{
    public $table = 'backend_warehouse.gondola_stock';
    public $table_batch = 'backend_warehouse.gondola_stock_batch';
    ...
    public function pre_item()
    {
        ...
        $sql = "SELECT BIN_ID FROM backend_warehouse.gondola_stock WHERE exported= 0 GROUP BY BIN_ID order by created_at desc ";
    ...
    {
        //data is retrive from this query
        $sql = "SELECT BIN_ID from backend_warehouse.gondola_stock_batch where exported=0 group by BIN_ID";
        $query = $this->db->query($sql);
        return $query;
    }
    ...
    {
        //data is retrive from this query
        $sql = "SELECT * FROM backend_warehouse.gondola_stock WHERE exported=0 AND BIN_ID = '$bin_ID' ORDER BY UPDATED_AT DESC LIMIT 3";
        $query = $this->db->query($sql);
        return $query;
    }
    ...
    public function pre_itemEdit2($itemcode)
    {
        ...
        $sql = "SELECT * FROM backend_warehouse.gondola_stock WHERE exported=0 and 
    ...
    {
        //data is retrive from this query
        $sql = "SELECT * FROM backend_warehouse.gondola_stock WHERE exported=0 AND BIN_ID='$bin_ID' order by Description";
        $query = $this->db->query($sql);
        return $query;
    ...
    {
        //data is retrive from this query
        $sql = "SELECT * FROM backend_warehouse.gondola_stock_batch WHERE exported=0 AND BIN_ID= '$bin_ID' ORDER BY CREATED_AT DESC";
        $query = $this->db->query($sql);
        return $query;
    ...
    {
        //data is retrive from this query
        $sql = "DELETE from backend_warehouse.gondola_stock where TRANS_GUID= '$TRANS_GUID' ";
        $query = $this->db->query($sql);
        return $query;
    ...
    {
        //data is retrive from this query
        $sql = "DELETE FROM backend_warehouse.gondola_stock_batch WHERE exported=0 AND BATCH_BARCODE= '$batch_barcode'  ";
        $query = $this->db->query($sql);
        return $query;
    ...
    {
        //data is retrive from this query
        $sql = "UPDATE backend_warehouse.gondola_stock SET send_print=1 WHERE exported=0 
        and BIN_ID = '$bin_ID' ";
        $query = $this->db->query($sql);
        return $query;
    ...
    {
        //data is retrive from this query
        $sql = "SELECT * FROM backend_warehouse.gondola_stock WHERE TRANS_GUID= '$TRANS_GUID' ";
        $query = $this->db->query($sql);
        return $query;
    ...
    {
        //data is retrive from this query
        $sql = "SELECT * FROM backend_warehouse.gondola_stock_batch WHERE exported=0 AND BATCH_BARCODE= '$barcode' ";
        $query = $this->db->query($sql);
        //echo $this->db->last_query();die;
        return $query;
    }
