            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1 class="page-head-line">
                        ...
                        <font>grn by po &nbsp<br><a href="<?php echo site_url('greceive_controller/po_post_grn')?>" ><button class="btn btn-default btn-sm" style=""><b>POST by GR ID</b></button></a>
                          <a href="<?php echo site_url('greceive_controller/search_gr')?>" ><button class="btn btn-default btn-sm" style=""><b><i class="fa fa-search fa-lg"></i>Search GRN</b></button></a></font>
                                  ...
                                  <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="big"><a href="<?php echo site_url('greceive_controller/po_batch')?>?grn_guid=<?php echo $row->grn_guid?>&po_no=<?php echo $row->po_no?>&sname=<?php echo $row->s_name;?>"><?php echo $row->s_name; ?></a></td>
